...
export const DEFAULT_COMMANDS: CommandAction[] = [
  ...
  {
    id: "navigate.context",
    labelKey: "commandPalette.commands.goContext",
    icon: Share2,
    category: "navigation",
    perform: (ctx) => ctx.navigate("/journey"),
  },
  {
    id: "navigate.goals",
  ...
  {
    id: "navigate.processes",
    labelKey: "commandPalette.commands.goProcesses",
    icon: Activity,
    category: "navigation",
    perform: (ctx) => ctx.navigate("/processes"),
  },
  {
    id: "navigate.finance",
  ...
  {
    id: "navigate.investments",
    labelKey: "commandPalette.commands.goInvestments",
    icon: LineChart,
    category: "navigation",
    perform: (ctx) => ctx.navigate("/investments"),
  },
  {
