...
export function normalizePptxText(value: unknown, textIndex: number): PptxText {
...
export function normalizePptxShapes(shapes: unknown[]): PptxShape[] {
  return shapes
...
export function normalizePptxTables(tables: unknown[]): PptxTable[] {
  return tables
...
export function normalizePptxImages(images: unknown[]): PptxImage[] {
  return images
      ...
      return {
        ...
        mimeType:
          typeof imageItem.mimeType === "string"
            ...
            : undefined,
        dataUrl:
          typeof imageItem.dataUrl === "string" ? imageItem.dataUrl : undefined,
...
export function normalizePptxMedia(media: unknown[]): PptxMedia[] {
  return media
...
export function normalizePptxCharts(charts: unknown[]): PptxChart[] {
  return charts
      ...
      return {
        ...
        relationshipId:
          typeof chartItem.relationshipId === "string"
            ...
            : undefined,
        path: typeof chartItem.path === "string" ? chartItem.path : undefined,
        type: typeof chartItem.type === "string" ? chartItem.type : undefined,
        title:
          typeof chartItem.title === "string" ? chartItem.title : undefined,
        legendVisible:
        ...
        valueMajorGridlines:
          typeof chartItem.valueMajorGridlines === "boolean"
            ...
            : undefined,
        categoryAxisTickLabelPosition: normalizePptxAxisTickLabelPosition(
        ...
        categoryAxisLineColor: hexColorField(chartItem.categoryAxisLineColor),
        ...
        series: Array.isArray(chartItem.series)
          ? chartItem.series
              ...
              .filter((series): series is PptxChartSeries => series !== null)
          : undefined,
      };
    })
    .filter(
